(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.AbsintheSocketGraphiql = {}));
	...
	var _wksDefine$1 = function (name) {
	  ...
	  if (name.charAt(0) != '_' && !(name in $Symbol)) defineProperty$2($Symbol, name, { value: _wksExt$1.f(name) });
	};
	...
	var setSymbolDesc$1 = _descriptors$1 && _fails$1(function () {
	  ...
	  dP$5(it, key, D);
	  if (protoDesc && it !== ObjectProto$3) dP$5(ObjectProto$3, key, protoDesc);
	} : dP$5;
	...
	var SubscriptionsClient = /*#__PURE__*/function () {
	  function SubscriptionsClient(socketUrl, options) {
	    ...
	    defineProperty$1(this, "absintheSocket", void 0);

	    defineProperty$1(this, "requestsCount", 0);

	    defineProperty$1(this, "requests", void 0);
