(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.AbsintheSocketApolloLink = {}));
	...
	***************************************************************************** */
	...
	var _iterDefine$1 = function (Base, NAME, Constructor, next, DEFAULT, IS_SET, FORCED) {
	  ...
	  if ($anyNative) {
	    ...
	    if (IteratorPrototype !== Object.prototype && IteratorPrototype.next) {
	      ...
	      if ( typeof IteratorPrototype[ITERATOR$5] != 'function') _hide(IteratorPrototype, ITERATOR$5, returnThis$1);
	    }
	  }
	  // fix Array#{values, @@iterator}.name in V8 / FF
	...
	function assertType(type) {
	  !isType(type) ? invariant$1(0, "Expected ".concat(inspect(type), " to be a GraphQL type.")) : void 0;
	  return type;
	}
	/**
	...
	function assertNullableType(type) {
	  !isNullableType(type) ? invariant$1(0, "Expected ".concat(inspect(type), " to be a GraphQL nullable type.")) : void 0;
	  return type;
	}
	/**
	...
	function () {
	  function GraphQLScalarType(config) {
	    ...
	    !(typeof config.serialize === 'function') ? invariant$1(0, "".concat(this.name, " must provide \"serialize\" function. If this custom Scalar ") + 'is also used as an input type, ensure "parseValue" and "parseLiteral" ' + 'functions are also provided.') : void 0;

	    if (config.parseValue || config.parseLiteral) {
	      !(typeof config.parseValue === 'function' && typeof config.parseLiteral === 'function') ? invariant$1(0, "".concat(this.name, " must provide both \"parseValue\" and \"parseLiteral\" ") + 'functions.') : void 0;
	    }
	  }
	...
	function () {
	  function GraphQLObjectType(config) {
	    ...
	    !(typeof config.name === 'string') ? invariant$1(0, 'Must provide name.') : void 0;
	    !(config.isTypeOf == null || typeof config.isTypeOf === 'function') ? invariant$1(0, "".concat(this.name, " must provide \"isTypeOf\" as a function, ") + "but got: ".concat(inspect(config.isTypeOf), ".")) : void 0;
	  }
	...
	function defineInterfaces(config) {
	  ...
	  !Array.isArray(interfaces) ? invariant$1(0, "".concat(config.name, " interfaces must be an Array or a function which returns ") + 'an Array.') : void 0;
	  return interfaces;
	}

	function defineFieldMap(config) {
	  var fieldMap = resolveThunk(config.fields) || {};
	  !isPlainObj(fieldMap) ? invariant$1(0, "".concat(config.name, " fields must be an object with field names as keys or a ") + 'function which returns such an object.') : void 0;
	  ...
	  var _loop = function _loop() {
	    ...
	    !isPlainObj(fieldConfig) ? invariant$1(0, "".concat(config.name, ".").concat(fieldName, " field config must be an object")) : void 0;
	    !!fieldConfig.hasOwnProperty('isDeprecated') ? invariant$1(0, "".concat(config.name, ".").concat(fieldName, " should provide \"deprecationReason\" ") + 'instead of "isDeprecated".') : void 0;
	    ...
	    !(field.resolve == null || typeof field.resolve === 'function') ? invariant$1(0, "".concat(config.name, ".").concat(fieldName, " field resolver must be a function if ") + "provided, but got: ".concat(inspect(field.resolve), ".")) : void 0;
	    var argsConfig = fieldConfig.args;

	    if (!argsConfig) {
	      field.args = [];
	    } else {
	      !isPlainObj(argsConfig) ? invariant$1(0, "".concat(config.name, ".").concat(fieldName, " args must be an object with argument ") + 'names as keys.') : void 0;
	...
	function () {
	  function GraphQLInterfaceType(config) {
	    ...
	    this._fields = defineFieldMap.bind(undefined, config);
	    !(typeof config.name === 'string') ? invariant$1(0, 'Must provide name.') : void 0;
	    !(config.resolveType == null || typeof config.resolveType === 'function') ? invariant$1(0, "".concat(this.name, " must provide \"resolveType\" as a function, ") + "but got: ".concat(inspect(config.resolveType), ".")) : void 0;
	  }
	...
	function defineTypes(config) {
	  ...
	  !Array.isArray(types) ? invariant$1(0, 'Must provide Array of types or a function which returns ' + "such an array for Union ".concat(config.name, ".")) : void 0;
	  return types;
	}
	...
	/* <T> */
	  ...
	  !isPlainObj(valueMap) ? invariant$1(0, "".concat(type.name, " values must be an object with value names as keys.")) : void 0;
	  return Object.keys(valueMap).map(function (valueName) {
	    var value = valueMap[valueName];
	    !isPlainObj(value) ? invariant$1(0, "".concat(type.name, ".").concat(valueName, " must refer to an object with a \"value\" key ") + "representing an internal value but got: ".concat(inspect(value), ".")) : void 0;
	    !!value.hasOwnProperty('isDeprecated') ? invariant$1(0, "".concat(type.name, ".").concat(valueName, " should provide \"deprecationReason\" instead ") + 'of "isDeprecated".') : void 0;
	    return {
	      name: valueName,
	...
	function defineInputFieldMap(config) {
	  ...
	  for (var _i2 = 0; _i2 < _arr2.length; _i2++) {
	    ...
	    !!field.hasOwnProperty('resolve') ? invariant$1(0, "".concat(config.name, ".").concat(fieldName, " field has a resolve property, but ") + 'Input Types cannot define resolvers.') : void 0;
	    resultFieldMap[fieldName] = field;
	  }
	...
	function () {
	  function GraphQLDirective(config) {
	    ...
	    if (!args) {
	      ...
	      !!Array.isArray(args) ? invariant$1(0, "@".concat(config.name, " args must be an object with argument names as keys.")) : void 0;
	...
	function isCollection(obj) {
	  return Object(obj) === obj && (isArrayLike(obj) || isIterable$2(obj))
	}
	...
	function getIterator$2(iterable) {
	...
	function forEach(collection, callback, thisArg) {
	  if (collection != null) {
	    ...
	    var i = 0;
	    var iterator = getIterator$2(collection);
	    if (iterator) {
	      var step;
	...
	function () {
	  ...
	  function GraphQLSchema(config) {
	    ...
	    if (config && config.assumeValid) {
	      ...
	      !(_typeof$4(config) === 'object') ? invariant$1(0, 'Must provide configuration object.') : void 0;
	      !(!config.types || Array.isArray(config.types)) ? invariant$1(0, "\"types\" must be Array if provided but got: ".concat(inspect(config.types), ".")) : void 0;
	      !(!config.directives || Array.isArray(config.directives)) ? invariant$1(0, '"directives" must be Array if provided but got: ' + "".concat(inspect(config.directives), ".")) : void 0;
	      !(!config.allowedLegacyNames || Array.isArray(config.allowedLegacyNames)) ? invariant$1(0, '"allowedLegacyNames" must be Array if provided but got: ' + "".concat(inspect(config.allowedLegacyNames), ".")) : void 0;
	    }
	...
	function typeMapReducer(map, type) {
	  ...
	  if (map[type.name]) {
	    !(map[type.name] === type) ? invariant$1(0, 'Schema must contain unique named types but contains multiple ' + "types named \"".concat(type.name, "\".")) : void 0;
	    return map;
	  }
